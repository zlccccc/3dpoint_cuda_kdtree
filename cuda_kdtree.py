...
if __name__ == '__main__':
    ...
    query_points = np.random.randint(0, 4096, 2048)
    ...
    print((time.time()-t)/9)
    t = time.time()
    points = np.random.random((8, 4096, 3))
    query_points = np.random.randint(0, 4096, (8, 1024))
    #print(points, query_points, 0.1, 16)
    now = index_points_numpy_for_testing(points,query_points)
    print('index: ', time.time()-t)
    query_ball_point_KD(points, now, 0.1, 16)
